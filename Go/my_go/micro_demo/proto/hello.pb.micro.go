...
func (c *helloService) Ping(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Hello.Ping", in)
	out := new(Response)
...
func (h *helloHandler) Ping(ctx context.Context, in *Request, out *Response) error {
